...
from IRDemo_python.camera_inf import *
...
class MyLabel(QLabel):
    ...
    def get_realpos(self, pt):  # 光标在图像中的坐标
        realpt = QPoint()
        realpt.setX((pt.x() - self.dis_woffset) * self.imgw / self.dis_width)
        realpt.setY((pt.y() - self.dis_hoffset) * self.imgh / self.dis_height)
        return realpt
